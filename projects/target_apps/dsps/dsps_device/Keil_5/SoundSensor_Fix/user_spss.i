...
#line 34 "..\\src\\user_spss.c"
#line 35 "..\\src\\user_spss.c"
#line 36 "..\\src\\user_spss.c"
#line 37 "..\\src\\user_spss.c"
...
#line 40 "..\\src\\user_spss.c"
#line 41 "..\\src\\user_spss.c"
...
void user_spss_create_db(void)
{
    ...
    struct gapm_profile_task_add_cmd *req = (struct gapm_profile_task_add_cmd*)ke_msg_alloc(GAPM_PROFILE_TASK_ADD_CMD, TASK_GAPM, TASK_APP, (sizeof(struct gapm_profile_task_add_cmd) + sizeof(struct spss_db_cfg)));;
...
void user_spss_enable(uint8_t conidx)
{
    ...
    struct sps_server_enable_req *req = (struct sps_server_enable_req*) ke_msg_alloc(SPS_SERVER_ENABLE_REQ, prf_get_task_from_id(TASK_ID_SPS_SERVER), TASK_APP, sizeof(struct sps_server_enable_req));
...
void user_send_ble_data(const uint8_t *data, uint16_t length)
{
    ...
    struct sps_server_data_tx_req * req = (struct sps_server_data_tx_req*)ke_msg_alloc_no_init(SPS_SERVER_DATA_TX_REQ, prf_get_task_from_id(TASK_ID_SPS_SERVER), TASK_APP, (sizeof(struct sps_server_data_tx_req) + length));;
...
void user_send_ble_flow_ctrl(uint8_t flow_ctrl)
{
    struct sps_server_rx_flow_ctrl_req * req = (struct sps_server_rx_flow_ctrl_req*) ke_msg_alloc(SPS_SERVER_RX_FLOW_CTRL_REQ, prf_get_task_from_id(TASK_ID_SPS_SERVER), TASK_APP, sizeof(struct sps_server_rx_flow_ctrl_req));
