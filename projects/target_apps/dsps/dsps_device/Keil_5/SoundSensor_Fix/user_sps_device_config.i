#line 1 "..\\src\\user_sps_device_config.c"
...
#line 30 "..\\src\\user_sps_device_config.c"
...
#line 31 "..\\src\\user_sps_device_config.c"
...
#line 32 "..\\src\\user_sps_device_config.c"
...
#line 35 "..\\src\\user_sps_device_config.c"
...
struct advertise_configuration user_adv_conf = {
    ...
    .intv_min = ((int) (((100) * 1000) / 625)),                    

    
    .intv_max = ((int) (((100) * 1000) / 625)),                    
...
struct connection_param_configuration user_connection_param_conf = {
    ...
    .time_out = ((int) ((10000) / 10)),

    
    
    .ce_len_min = ((int) (((40) * 1000) / 1250)),

    
    
    .ce_len_max = ((int) (((40) * 1000) / 1250)),
};

#line 302 "..\\src\\user_sps_device_config.c"

char user_advertise_data[28] = "\x11\x07\xb7\x5c\x49\xd2\x04\xa3\x40\x71\xa0\xb5\x35\x85\x3e\xb0\x83\x07" "\x03" "\x03" "\xF5\xFE";
uint8_t user_advertise_data_len = (sizeof("\x11\x07\xb7\x5c\x49\xd2\x04\xa3\x40\x71\xa0\xb5\x35\x85\x3e\xb0\x83\x07" "\x03" "\x03" "\xF5\xFE")-1);
char user_adv_scan_resp_data[31] = "";
uint8_t user_adv_scan_resp_data_len = (sizeof("")-1);


char * spss_conf_struct_version = "SPSS CONF v0";
uint8_t spss_conf_struct_version_len = sizeof("SPSS CONF v0")-1;

gpio_func_t gpio_uart1_rx = {GPIO_PIN_5, GPIO_PORT_0};
gpio_func_t gpio_uart1_tx = {GPIO_PIN_6, GPIO_PORT_0};
gpio_func_t gpio_uart1_cts = {GPIO_PIN_8, GPIO_PORT_0};
gpio_func_t gpio_uart1_rts = {GPIO_PIN_7, GPIO_PORT_0};
...
gpio_func_t gpio_reset_status = {GPIO_PIN_INVALID, GPIO_PORT_0};
...
user_config_elem_t    spss_configuration_table[USER_CONF_ELEMENTS_NUM] = {
                                                {ELEM_ID_ADV_INTERVAL_MIN, 2, 2, &user_adv_conf.intv_min, user_sps_config_verify_adv_int_min_cb, 0},
                                                {ELEM_ID_ADV_INTERVAL_MAX, 2, 2, &user_adv_conf.intv_max, user_sps_config_verify_adv_int_max_cb, 0},
                                                {ELEM_ID_ADV_CHANNEL_MAP, 1, 1, &user_adv_conf.channel_map, user_sps_config_verify_adv_channel_map_cb, 0},
                                                {ELEM_ID_GAP_MTU, 2, 2, &user_gapm_conf.max_mtu, user_sps_config_verify_mtu_cb, 0},
                                                {ELEM_ID_CONN_INTERVAL_MIN, 2, 2, &user_connection_param_conf.intv_min, user_sps_config_verify_ci_min_cb, 0},
                                                {ELEM_ID_CONN_INTERVAL_MAX, 2, 2, &user_connection_param_conf.intv_max, user_sps_config_verify_ci_max_cb, 0},
                                                {ELEM_ID_CONN_LATENCY, 2, 2, &user_connection_param_conf.latency, user_sps_config_verify_sl_cb, 0},
                                                {ELEM_ID_CONN_TIME_OUT, 2, 2, &user_connection_param_conf.time_out, user_sps_config_verify_sup_to_cb, 0},
                                                {ELEM_ID_USER_ADV_DATA, 28, (sizeof("\x11\x07\xb7\x5c\x49\xd2\x04\xa3\x40\x71\xa0\xb5\x35\x85\x3e\xb0\x83\x07" "\x03" "\x03" "\xF5\xFE")-1), user_advertise_data, 0, 0},
                                                {ELEM_ID_USER_ADV_DATA_LEN, 1, 1, &user_advertise_data_len, 0, 0},
                                                {ELEM_ID_USER_ADV_SCAN_RESP_DATA, 31, (sizeof("")-1), 0, 0, 0},
                                                {ELEM_ID_USER_ADV_SCAN_RESP_DATA_LEN, 1, 1, &user_adv_scan_resp_data_len, 0, 0},
                                                {ELEM_ID_USER_DEVICE_NAME, 32, (sizeof("SPS_531")-1), device_info.dev_name.name, 0, 0},
                                                {ELEM_ID_USER_DEVICE_NAME_LEN, 1, 1, &device_info.dev_name.length, 0, 0},





                                                {ELEM_ID_GPIO_ACTIVE_STATUS_PIN, 2, 2, &gpio_reset_status, user_sps_config_verify_gpio_config_cb, 0},
...
uint8_t user_sps_config_verify_ci_min_cb(uint8_t* param)
{
    ...
    if ((val < 6) || (val > 3200) || (val > user_connection_param_conf.intv_max))
        return 1;
    else return 0;
}
...
uint8_t user_sps_config_verify_ci_max_cb(uint8_t* param)
{
    ...
    if ((val < 6) || (val > 3200) || (interval >= (user_connection_param_conf.time_out * 10)) || (val < user_connection_param_conf.intv_min))
        return 1;
    else return 0;
}
...
uint8_t user_sps_config_verify_sl_cb(uint8_t* param)
{
    ...
    if ((val > 499) || ( interval >= (user_connection_param_conf.time_out * 10)))
        return 1;
    else return 0;
}
...
uint8_t user_sps_config_verify_sup_to_cb(uint8_t* param)
{
    ...
    if ((val < 10 || val > 3200) || ( interval >= (val * 10)))
        return 1;
    else return 0;
}
...
uint8_t user_sps_config_verify_adv_int_min_cb(uint8_t* param)
{
    ...
    if (val < 32 || val > 16384 || val > user_adv_conf.intv_max)
        return 1;
    else return 0;
}
...
uint8_t user_sps_config_verify_adv_int_max_cb(uint8_t* param)
{
    ...
    if (val < 32 || val > 16384 || val < user_adv_conf.intv_min)
        return 1;
    else return 0;
}
...
#line 502 "..\\src\\user_sps_device_config.c"
