#line 1 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\i2c_eeprom\\i2c_eeprom.c"
...
#line 21 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\i2c_eeprom\\i2c_eeprom.c"
#line 22 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\i2c_eeprom\\i2c_eeprom.c"
#line 1 ".\\..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\arch\\compiler\\compiler.h"
...
#line 23 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\i2c_eeprom\\i2c_eeprom.c"
#line 24 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\i2c_eeprom\\i2c_eeprom.c"
#line 25 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\i2c_eeprom\\i2c_eeprom.c"
#line 26 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\i2c_eeprom\\i2c_eeprom.c"
...
static i2c_eeprom_env_t i2c_eeprom_env      __attribute__((section("retention_mem_area0"), zero_init));
...
i2c_error_code i2c_wait_until_eeprom_ready(void)
{
    ...
    {
        i2c_write_last_byte(0x08);                              
        while (i2c_is_tx_fifo_empty() == 0);                    
        while (i2c_is_master_busy());                           
        tx_abrt_source = i2c_get_abort_source();                
        i2c_reset_int_tx_abort();                               
...
static void i2c_eeprom_send_address(uint32_t address)
{
    switch(i2c_eeprom_env.eeprom.address_size)
    {
        case I2C_2BYTES_ADDR:
        {
            ...
            i2c_set_target_address(i2c_eeprom_env.i2c.address | ((address & 0x30000) >> 16));  
        ...
        {
            i2c_write_byte((address >> 16) & 0xFF);     
            i2c_write_byte((address >> 8) & 0xFF);      
            break;
        }
    }
...
i2c_error_code i2c_eeprom_read_byte(uint32_t address, uint8_t *byte)
{
    ...
    i2c_write_last_byte((0x0100));                   

    
    

    while (i2c_get_rx_fifo_level() == 0);           
    *byte = i2c_read_byte();                        
...
static void read_data_single(uint8_t **p, uint32_t address, uint32_t size)
{
    ...
    for (j = 0; j < size - 1 ; j++)
    {
        while (i2c_is_tx_fifo_not_full() == 0);     
        i2c_write_byte((0x0100));
    }
    ...
    *bytes_written = 0;
    ...
    if (address < i2c_eeprom_env.eeprom.size)
    {
        ...
        do
        {
            ...
            {
                i2c_write_byte(*wr_data_ptr & 0xFF);          
            }
