#line 1 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\trng\\trng.c"
...
#line 26 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\trng\\trng.c"
#line 27 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\trng\\trng.c"
#line 28 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\trng\\trng.c"
...
#line 29 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\trng\\trng.c"
#line 30 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\trng\\trng.c"
...
#line 35 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\trng\\trng.c"


#line 39 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\trng\\trng.c"
#line 1 ".\\..\\..\\..\\..\\..\\sdk6\\third_party\\irng\\iid_return_codes.h"
...
#line 40 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\trng\\trng.c"
...
#line 41 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\trng\\trng.c"
#line 47 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\trng\\trng.c"

#line 238 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\trng\\trng.c"

static uint8_t trng_bits[((16))]    __attribute__((aligned(4))); 


uint32_t trng_state_val              __attribute__((section("trng_state"), zero_init)); 



static uint8_t extra_samples[(4)];
...
void init_rand_seed_from_trng(void) __attribute__((section("system_init_run_once")));
...
void init_rand_seed_from_trng(void)
{
    ...
    {
        uint8_t status = 0x00;
        uint8_t *buffer = ke_malloc((((28)) * ((16))), KE_MEM_ATT_DB);
        
        get_extra_samples();

        for (uint32_t i = 0; i < (((28)) * ((16))); i++)
        {
            buffer[i] ^= buffer[((((28)) * ((16))) - 1) - i] ^ extra_samples[buffer[i] & ((4) - 1)];
        }

        status = trng_acquire(trng_bits, buffer, ((28)));

        { do { if (0) { if (!(status == 0x00)) { __breakpoint(0); } } } while (0); };
