#line 1 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\utilities\\otp_cs\\otp_cs.c"
...
#line 23 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\utilities\\otp_cs\\otp_cs.c"
#line 24 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\utilities\\otp_cs\\otp_cs.c"
#line 25 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\utilities\\otp_cs\\otp_cs.c"
...
#line 26 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\utilities\\otp_cs\\otp_cs.c"
...
#line 27 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\utilities\\otp_cs\\otp_cs.c"
#line 1 ".\\..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\arch\\compiler\\compiler.h"
...
#line 28 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\utilities\\otp_cs\\otp_cs.c"
...
otp_cs_booter_val_t booter_val  __attribute__((section("otp_cs_booter"))) =
{
    
    .dbg_cfg       = 0,

    
    .bandgap_reg   = (0x00000000),

    
    .clk_rc32m_reg = (0x0000078E),

    
    .clk_rc32k_reg = (0x0000000E)
};
...
static otp_cs_t otp_cs     __attribute__((section("retention_mem_area0"), zero_init)); 
...
static __forceinline int16_t calc_adc_ge(uint16_t low, uint16_t high)
{
    return (((high - low) + ((uint16_t) (high - low) >> 2)) - 65535);
}
...
static __forceinline int16_t calc_adc_offset(uint16_t low, uint16_t high)
{
    return ((int16_t) ((9 * low) - high) >> 3);
}

int8_t otp_cs_store(void) __attribute__((section("system_init_run_once")));
int8_t otp_cs_store(void)
{
    ...
    if((* ( volatile uint32_t*)(((0x07F80000) + (0x7ED0))) ) != (0xA5A5A5A5))
    {
        return (-1); 
    }
    ...
    while (((0x07F80000) + (0x7ED0)) + offset < (((0x07F80000) + (0x7ED0)) + ((60) * 4)))
    {
        value = (* ( volatile uint32_t*)(((0x07F80000) + (0x7ED0)) + offset) );
        ...
        if ((value & 0xF0000000) == (0x90000000))
        {
            ...
            switch (id)
            {
                ...
                case (6):
                {
                    memcpy(&otp_cs.pd_rad[otp_cs.pd_rad_pairs], (void *) (((0x07F80000) + (0x7ED0)) + offset + 4), num * sizeof(uint32_t));
                    otp_cs.pd_rad_pairs = otp_cs.pd_rad_pairs + num;
                    { do { if (0) { if (!(otp_cs . pd_rad_pairs <= ((2) * 2))) { __breakpoint(0); } } } while (0); };
                    break;
                }
                case (7):
                {
                    memcpy(&otp_cs.pd_adpll[otp_cs.pd_adpll_pairs], (void *) (((0x07F80000) + (0x7ED0)) + offset + 4), num * sizeof(uint32_t));
                    otp_cs.pd_adpll_pairs = otp_cs.pd_adpll_pairs + num;
                    { do { if (0) { if (!(otp_cs . pd_adpll_pairs <= ((6) * 2))) { __breakpoint(0); } } } while (0); };
                    break;
                }
                case (17):
                {
                    
                    uint16_t low  = (uint16_t) (* ( volatile uint32_t*)(((0x07F80000) + (0x7ED0)) + offset + 4) );
                    uint16_t high = (uint16_t) ((* ( volatile uint32_t*)(((0x07F80000) + (0x7ED0)) + offset + 4) ) >> 16);
                ...
                case (19):
                {
                    memcpy(&gp_adc_gen[gp_adc_gen_idx], (void *) (((0x07F80000) + (0x7ED0)) + offset + 4), num * sizeof(uint32_t));
                    gp_adc_gen_idx = gp_adc_gen_idx + num;
                    { do { if (0) { if (!(gp_adc_gen_idx <= (2))) { __breakpoint(0); } } } while (0); }
                    break;
                }
                case (20):
                {
                    
                    otp_cs.trim_values.adc_25_cal = (uint16_t) (* ( volatile uint32_t*)(((0x07F80000) + (0x7ED0)) + offset + 4) );
                    break;
                }
                case (22):
                {
                    otp_cs.trim_values.lp_clk_set[0] = (* ( volatile uint32_t*)(((0x07F80000) + (0x7ED0)) + offset + 4) );
                    break;
                }
                case (23):
                {
                    
                    otp_cs.trim_values.xtal_wait_trim = (uint16_t) (* ( volatile uint32_t*)(((0x07F80000) + (0x7ED0)) + offset + 4) );
                    { do { if (0) { if (!(otp_cs . trim_values . xtal_wait_trim)) { __breakpoint(0); } } } while (0); } 
                    break;
                }
                default:
                {
        ...
        else if (value >= 0x40000000 && value <= 0x5000424C)
        {
            ...
            if (value == (0x50000028))
            {
                ...
                booter_val.bandgap_reg = (uint16_t) (* ( volatile uint32_t*)(((0x07F80000) + (0x7ED0)) + offset - 4) );
            }
            else if (value == (0x50000002))
            {
                
                otp_cs.trim_values.xtal_trim_value = (uint16_t) (* ( volatile uint32_t*)(((0x07F80000) + (0x7ED0)) + offset - 4) );
            }
            else if (value == (0x50000024))
            {
                
                booter_val.clk_rc32m_reg = (uint16_t) (* ( volatile uint32_t*)(((0x07F80000) + (0x7ED0)) + offset - 4) );
            }
            else if (value == (0x50000020))
            {
                
                booter_val.clk_rc32k_reg = (uint16_t) (* ( volatile uint32_t*)(((0x07F80000) + (0x7ED0)) + offset - 4) );
            }
        }
        ...
        else if ((value & 0xF0000000) == (0x80000000))
        {
            
            offset = offset + 4;
        }
        else if ((value & 0xF0000000) == (0xA0000000))
        {
    ...
    { do { if (0) { if (!(!(otp_cs . pd_rad_pairs & 1U))) { __breakpoint(0); } } } while (0); }
    otp_cs.pd_rad_pairs = otp_cs.pd_rad_pairs >> 1U;

    
    { do { if (0) { if (!(!(otp_cs . pd_adpll_pairs & 1U))) { __breakpoint(0); } } } while (0); }
    otp_cs.pd_adpll_pairs = otp_cs.pd_adpll_pairs >> 1U;
    
    
    if (!otp_cs.trim_values.xtal_wait_trim)
    {
        otp_cs.trim_values.xtal_wait_trim = (1000);
    }

    
    { do { if (0) { if (!(otp_cs . pd_adpll_pairs == 4)) { __breakpoint(0); } } } while (0); }

#line 354 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\utilities\\otp_cs\\otp_cs.c"
...
void otp_cs_load_pd_rad(void)
{
    ...
    {
#line 368 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\utilities\\otp_cs\\otp_cs.c"
        if ((otp_cs.pd_rad[i].addr == (0x4000104C)) &&
            (((otp_cs.pd_rad[i].val >> 10U) & 0x7FFF) != 0) &&  
            (rf_pa_pwr_get() > RF_TX_PWR_LVL_0d0))         
            {
                (* ( volatile uint32_t*)(otp_cs . pd_rad[i]. addr)=((otp_cs . pd_rad[i]. val & (0x0300)) | ((otp_cs . pd_rad[i]. val >> 10) & 0x03F)) );
                txdiv_trim = (otp_cs.pd_rad[i].val >> 16U) & 0x01FF; 
                continue;
            }

        (* ( volatile uint32_t*)(otp_cs . pd_rad[i]. addr)=(otp_cs . pd_rad[i]. val) );
    }
}
...
void otp_cs_load_pd_adpll(void)
{
    ...
    {
#line 391 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\utilities\\otp_cs\\otp_cs.c"
        



 
        if ((otp_cs.pd_adpll[i].addr == (0x40003038)) &&
            (rf_pa_pwr_get() > RF_TX_PWR_LVL_0d0))    
            {
                (* ( volatile uint32_t*)(otp_cs . pd_adpll[i]. addr)=(((otp_cs . pd_adpll[i]. val & (~(0x3FE0000))) | (txdiv_trim << 17U))) );
                continue;
            }

        (* ( volatile uint32_t*)(otp_cs . pd_adpll[i]. addr)=(otp_cs . pd_adpll[i]. val) );
    }
}
...
#line 485 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\utilities\\otp_cs\\otp_cs.c"
