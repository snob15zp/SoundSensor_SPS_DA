...
_Bool MS_b_alert_C140dBPeak;
_Bool MS_b_alert_FastA;
_Bool MS_b_alert_live;
_Bool MS_b_alert_Overload;
_Bool MS_b_alert_DoseM3dB;	
_Bool MS_b_alert_Dose;


int32_t MS_i32_AlertLevel_FastA;

int32_t MS_i32_AlertLevel_Dose;
int32_t MS_i32_AlertLevel_DoseM3dB;

int32_t MS_i32_Level_C_Peak_dB;
...
MS_i32_Level_FastA_dB=  100.0*(10.0*log10(a) + 49.88); 
MS_i32_Level_Dose_dB=   100.0*(10.0*log10(i) + ((62.484)));	
MS_i32_Level_C_Peak_dB= 100.0*(20.0*log10(c) + (-23.70202241));
...
void MS_Alerts(uint32_t time)
{
	...
	MS_b_alert_C140dBPeak=(PeakC_max>153144400);
	...
	if ((time-MF_ADCOverLoad_Flag_time)<(1000000/1000))
	{
	 MS_b_alert_Overload=1;
	}
	else
	{ 
		MS_b_alert_Overload=0;
		MF_ADCOverLoad_Flag_time=time-(1000000/1000)*2;
	}
...
MS_i32_AlertLevel_FastA=((85))*(100.0);

MS_i32_AlertLevel_Dose=((85))*(100.0);
MS_i32_AlertLevel_DoseM3dB=(((85)-3))*(100.0);


MS_b_alert_C140dBPeak=0;
MS_b_alert_FastA=0;
MS_b_alert_live=0;	
MS_b_alert_Overload=0;
MS_b_alert_DoseM3dB=0;	
MS_b_alert_Dose=0;


MS_i32_Level_C_Peak_dB=0;
MS_i32_Level_FastA_dB=0;
MS_i32_Level_Dose_dB=0;
