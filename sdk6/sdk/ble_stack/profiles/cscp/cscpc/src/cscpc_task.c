                                        ...
                                        ke_task_id_t const src_id)
{
    ...
    if (cscpc_env != NULL)
    {
        ...
        do
        {
            ...
            ASSERT_ERROR(cscpc_env->env[conidx] != NULL);
            ...
            switch(param->desc_code)
            {
                ...
                case (CSCPC_RD_WR_CSC_MEAS_CFG):
                {
                    if (param->ntfind_cfg <= PRF_CLI_START_NTF)
                    {
                        ...
                        ASSERT_ERROR(handle != ATT_INVALID_SEARCH_HANDLE);
                        status = GAP_ERR_NO_ERROR;
                    }
                    else
                    {
                                         ...
                                         ke_task_id_t const src_id)
{
    ...
    if (cscpc_env != NULL)
    {
        ...
        do
        {
            ...
            ASSERT_ERROR(ke_state_get(dest_id) > CSCPC_FREE);
                                           ...
                                           ke_task_id_t const src_id)
{
    ...
    if (cscpc_env != NULL)
    {
        ASSERT_ERROR(cscpc_env->env[conidx]->operation != NULL);
        ASSERT_ERROR(((struct cscpc_cmd *)cscpc_env->env[conidx]->operation)->operation == CSCPC_CTNL_PT_CFG_IND_OP_CODE);
