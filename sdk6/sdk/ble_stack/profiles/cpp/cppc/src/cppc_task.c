                                        ...
                                        ke_task_id_t const src_id)
{
    ...
    if (cppc_env != NULL)
    {
        ...
        do
        {
            ...
            ASSERT_ERROR(cppc_env->env[conidx] != NULL);
                                         ...
                                         ke_task_id_t const src_id)
{
    ...
    if (cppc_env != NULL)
    {
        ...
        do
        {
            ...
            ASSERT_ERROR(ke_state_get(dest_id) > CPPC_FREE);
                                           ...
                                           ke_task_id_t const src_id)
{
    ...
    if (cppc_env != NULL)
    {
        ASSERT_ERROR(cppc_env->env[conidx]->operation != NULL);
        ASSERT_ERROR(((struct cppc_cmd *)cppc_env->env[conidx]->operation)->operation == CPPC_CTNL_PT_CFG_IND_OP_CODE);
