#line 1 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_suotar\\app_suotar.c"
...
#line 28 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_suotar\\app_suotar.c"



#line 32 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_suotar\\app_suotar.c"
...
#line 33 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_suotar\\app_suotar.c"
#line 34 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_suotar\\app_suotar.c"
#line 35 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_suotar\\app_suotar.c"
#line 36 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_suotar\\app_suotar.c"
#line 38 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_suotar\\app_suotar.c"
#line 39 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_suotar\\app_suotar.c"
...
#line 45 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_suotar\\app_suotar.c"
...
#line 51 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_suotar\\app_suotar.c"
#line 52 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_suotar\\app_suotar.c"
...
#line 54 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_suotar\\app_suotar.c"
#line 56 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_suotar\\app_suotar.c"
...
app_suota_state suota_state __attribute__((section("retention_mem_area0"), zero_init)); 

__attribute__((aligned(4))) uint8_t suota_all_pd[0x200] __attribute__((section("retention_mem_area0"), zero_init)); 
...
void app_suotar_init(void)
{
    ...
    memset( suota_all_pd, 0x00, sizeof(uint32_t)); 
...
void app_suotar_create_db(void)
{
    ...
    struct gapm_profile_task_add_cmd *req = (struct gapm_profile_task_add_cmd*)ke_msg_alloc(GAPM_PROFILE_TASK_ADD_CMD, TASK_GAPM, TASK_APP, (sizeof(struct gapm_profile_task_add_cmd) + sizeof(struct suotar_db_cfg)));;
...
void app_suotar_read_mem(uint32_t mem_dev, uint32_t* mem_info)
{
    ...
    uint8_t mem_dev_cmd = (uint8_t) ((mem_dev & 0xFF000000) >> 24);

    
    if( mem_dev_cmd < SUOTAR_MEM_INVAL_DEV )
    {
        suota_state.mem_dev = (uint8_t) ((mem_dev & 0xFF000000) >> 24);
        suota_state.mem_base_add = mem_dev & 0x0000FFFF;
            ...
            (suota_state.mem_dev == SUOTAR_MEM_INT_RETRAM) )
        {
            ...
            suota_state.mem_base_add = (uint32_t)(suota_all_pd + (0x200 - sizeof(uint32_t)));
        }
    ...
    switch( mem_dev_cmd )
    {
        ...
        case SUOTAR_REBOOT:
        {
            if (app_env[0].conidx == 0xFF)
            {
                
                platform_reset((0x11111111));
            } else {
...
void on_suotar_status_change(const uint8_t suotar_event)
{
    ...
    user_spi_flash_init(((uint32_t)GPIO_PIN_4 | ((uint32_t)GPIO_PORT_0 << 4) | ((uint32_t)GPIO_PIN_1 << 8) | ((uint32_t)GPIO_PORT_0 << 12) | ((uint32_t)GPIO_PIN_0 << 16) | ((uint32_t)GPIO_PORT_0 << 20) | ((uint32_t)GPIO_PIN_3 << 24) | ((uint32_t)GPIO_PORT_0 << 28)));

#line 268 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_suotar\\app_suotar.c"
}
...
void app_suotar_start(void)
{
    ...
    {if (user_app_suotar_cb . on_suotar_status_change != 0) user_app_suotar_cb . on_suotar_status_change(1);};

    if( ( (((suota_state . mem_dev) & 0x10) >> 4 ) == 1) )
    {
...
void app_suotar_stop(void)
{
#line 309 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_suotar\\app_suotar.c"
    ...
    {if (user_app_suotar_cb . on_suotar_status_change != 0) user_app_suotar_cb . on_suotar_status_change(0);};
...
void suotar_send_status_update_req( uint8_t status )
{
    ...
    struct suotar_status_update_req *req = (struct suotar_status_update_req*) ke_msg_alloc(SUOTAR_STATUS_UPDATE_REQ, prf_get_task_from_id(TASK_ID_SUOTAR), TASK_APP, sizeof(struct suotar_status_update_req));
...
void suotar_send_mem_info_update_req(uint32_t mem_info)
{
    ...
    struct suotar_patch_mem_info_update_req *req = (struct suotar_patch_mem_info_update_req*) ke_msg_alloc(SUOTAR_PATCH_MEM_INFO_UPDATE_REQ, prf_get_task_from_id(TASK_ID_SUOTAR), TASK_APP, sizeof(struct suotar_patch_mem_info_update_req));
...
void app_suotar_img_hdlr(void)
{
    ...
    switch (suota_state.mem_dev)
    {
        case SUOTAR_IMG_I2C_EEPROM:
        {
#line 420 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_suotar\\app_suotar.c"
        ...
        case SUOTAR_IMG_SPI_FLASH:
        {
            ...
            else
            {
                ...
                if (( suota_state.suota_image_len+1+5 ) >= ( suota_state.suota_img_idx + suota_state.suota_block_idx ))
                {
...
#line 512 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_suotar\\app_suotar.c"
...
int app_read_image_headers(uint8_t image_bank, uint8_t* data, uint32_t data_len)
{
    ...
    ret = app_read_ext_mem( (uint8_t*)mem_data_buff, (unsigned long)0x38000, (unsigned long)sizeof(config_product_header_t) );
    if(ret < 0)
        return SUOTAR_EXT_MEM_READ_ERR;

    
    if( (pProductHeader->signature[0] != 0x70) ||
        (pProductHeader->signature[1] != 0x52)    )
    {
        return SUOTAR_INVAL_PRODUCT_HDR;
    }

    if( (pfwHeader->signature[0] == 0x70) && (pfwHeader->signature[1] == 0x54) &&
        (pfwHeader->validflag == 0xAA) )
    {
        uint32_t len;
        ...
        pfwHeader->validflag = 0xFF;
        len = (data_len == suota_state.suota_image_len + 1) ? suota_state.suota_image_len : data_len;
    ...
    if( (pfwHeader->signature[0] != 0x70) || (pfwHeader->signature[1] != 0x51) )
    {
        return SUOTAR_INVAL_IMG_HDR;
    }
    ...
    if( (pImageHeader->validflag != 0xAA)         ||
        (pImageHeader->signature[0] != 0x70) ||
        (pImageHeader->signature[1] != 0x51)    )
    {
        is_invalid_image1 = 1;
        imageid1 = 0;
    } else {
    ...
    if (new_bank == 2)
    {
        if (is_invalid_image2==2) return SUOTAR_SAME_IMG_ERR;
    ...
    {
        if (is_invalid_image1==2) return SUOTAR_SAME_IMG_ERR;
    ...
    {
#line 717 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_suotar\\app_suotar.c"
        return SUOTAR_EXT_MEM_WRITE_ERR;
    ...
    if( suota_state.mem_dev == SUOTAR_IMG_SPI_FLASH )
    {
        ...
        ret = user_flash_write_data((uint8_t*) &data[64], suota_state.mem_base_add + 64, data_len - 64);
        if(ret < 0) return SUOTAR_EXT_MEM_WRITE_ERR;
    ...
    {
#line 762 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_suotar\\app_suotar.c"
        return SUOTAR_EXT_MEM_WRITE_ERR;
...
uint8_t app_set_image_valid_flag(void)
{
    ...
    {
#line 810 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_suotar\\app_suotar.c"
    }
...
int app_read_ext_mem( uint8_t *rd_data_ptr, uint32_t address, uint32_t size )
{
    ...
    {
#line 890 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_suotar\\app_suotar.c"
    }
    return ret;
}
