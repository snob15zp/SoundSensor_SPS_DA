#line 1 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\arch\\main\\nmi_handler.c"
...
#line 16 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\arch\\main\\nmi_handler.c"
#line 17 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\arch\\main\\nmi_handler.c"
#line 18 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\arch\\main\\nmi_handler.c"
...
#line 19 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\arch\\main\\nmi_handler.c"
...
void NMI_HandlerC(unsigned long *hardfault_args)
{
    ...
    __NVIC_ClearPendingIRQ(BLE_WAKEUP_LP_IRQn);       

    if (0)
    {
        wdg_freeze();            
#line 55 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\arch\\main\\nmi_handler.c"
        syscntl_load_debugger_cfg();        

        *(volatile unsigned long *)((0x07FC9050)       ) = hardfault_args[0];    
        *(volatile unsigned long *)((0x07FC9050) + 0x04) = hardfault_args[1];    
        *(volatile unsigned long *)((0x07FC9050) + 0x08) = hardfault_args[2];    
        *(volatile unsigned long *)((0x07FC9050) + 0x0C) = hardfault_args[3];    
        *(volatile unsigned long *)((0x07FC9050) + 0x10) = hardfault_args[4];    
        *(volatile unsigned long *)((0x07FC9050) + 0x14) = hardfault_args[5];    
        *(volatile unsigned long *)((0x07FC9050) + 0x18) = hardfault_args[6];    
        *(volatile unsigned long *)((0x07FC9050) + 0x1C) = hardfault_args[7];    
        *(volatile unsigned long *)((0x07FC9050) + 0x20) = (unsigned long)hardfault_args;    

        *(volatile unsigned long *)((0x07FC9050) + 0x24) = (*((volatile unsigned long *)(0xE000ED28)));    
        *(volatile unsigned long *)((0x07FC9050) + 0x28) = (*((volatile unsigned long *)(0xE000ED2C)));    
        *(volatile unsigned long *)((0x07FC9050) + 0x2C) = (*((volatile unsigned long *)(0xE000ED30)));    
        *(volatile unsigned long *)((0x07FC9050) + 0x30) = (*((volatile unsigned long *)(0xE000ED3C)));    
        *(volatile unsigned long *)((0x07FC9050) + 0x34) = (*((volatile unsigned long *)(0xE000ED34)));    
        *(volatile unsigned long *)((0x07FC9050) + 0x38) = (*((volatile unsigned long *)(0xE000ED38)));    
    ...
    (* ( volatile uint16_t*)((0x50000012))=(((* ( volatile uint16_t*)((0x50000012)) ) & ~(0x0003)) | (0x8000)) );
