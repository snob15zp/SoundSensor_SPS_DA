...
D:\Keil_v5\UV4\UV4.exe -b utilities\secondary_bootloader\secondary_bootloader.uvprojx
...
utilities\mkimage.exe multi spi out\secondary_bootloader_531.bin out\dsps_device_531.A.img 0x4000 out\dsps_device_531.B.img 0x10000 0x1f000 out\dsps_device_531.release.img
