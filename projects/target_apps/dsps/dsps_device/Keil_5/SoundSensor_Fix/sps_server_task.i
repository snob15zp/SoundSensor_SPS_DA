#line 1 "..\\..\\common\\src\\profiles\\spss\\sps_server_task.c"
...
#line 27 "..\\..\\common\\src\\profiles\\spss\\sps_server_task.c"



#line 31 "..\\..\\common\\src\\profiles\\spss\\sps_server_task.c"
#line 32 "..\\..\\common\\src\\profiles\\spss\\sps_server_task.c"

#line 34 "..\\..\\common\\src\\profiles\\spss\\sps_server_task.c"
#line 35 "..\\..\\common\\src\\profiles\\spss\\sps_server_task.c"

#line 37 "..\\..\\common\\src\\profiles\\spss\\sps_server_task.c"
#line 1 "..\\..\\common\\src\\profiles\\spss\\user_sps_config.h"
...
#line 32 "..\\..\\common\\src\\profiles\\spss\\user_sps_config.h"
#line 33 "..\\..\\common\\src\\profiles\\spss\\user_sps_config.h"
#line 34 "..\\..\\common\\src\\profiles\\spss\\user_sps_config.h"
...
#line 35 "..\\..\\common\\src\\profiles\\spss\\user_sps_config.h"
...
enum
{
 ...
 static const struct att_uuid_128  sps_service = {{0xb7, 0x5c, 0x49, 0xd2, 0x04, 0xa3, 0x40, 0x71, 0xa0, 0xb5, 0x35, 0x85, 0x3e, 0xb0, 0x83, 0x07}};

static const struct att_char128_desc  spss_tx_data_char  = {0x10, {0,0}, {0xb8, 0x5c, 0x49, 0xd2, 0x04, 0xa3, 0x40, 0x71, 0xa0, 0xb5, 0x35, 0x85, 0x3e, 0xb0, 0x83, 0x07}};  
static const struct att_uuid_128  spss_tx_data_val = {{0xb8, 0x5c, 0x49, 0xd2, 0x04, 0xa3, 0x40, 0x71, 0xa0, 0xb5, 0x35, 0x85, 0x3e, 0xb0, 0x83, 0x07}};

static const struct att_char128_desc  spss_rx_data_char  = {0x04, {0,0}, {0xba, 0x5c, 0x49, 0xd2, 0x04, 0xa3, 0x40, 0x71, 0xa0, 0xb5, 0x35, 0x85, 0x3e, 0xb0, 0x83, 0x07}}; 
static const struct att_uuid_128  spss_rx_data_val = {{0xba, 0x5c, 0x49, 0xd2, 0x04, 0xa3, 0x40, 0x71, 0xa0, 0xb5, 0x35, 0x85, 0x3e, 0xb0, 0x83, 0x07}};


static const struct att_char128_desc  spss_flow_ctrl_char  = {0x10|0x04|0x02, {0,0}, {0xb9, 0x5c, 0x49, 0xd2, 0x04, 0xa3, 0x40, 0x71, 0xa0, 0xb5, 0x35, 0x85, 0x3e, 0xb0, 0x83, 0x07}}; 
static const struct att_uuid_128  spss_flow_ctrl_val = {{0xb9, 0x5c, 0x49, 0xd2, 0x04, 0xa3, 0x40, 0x71, 0xa0, 0xb5, 0x35, 0x85, 0x3e, 0xb0, 0x83, 0x07}};
...
static const struct attm_desc_128 sps_att_db[SPSS_IDX_NB] =
{
    ...
    [SPSS_IDX_SVC]                      = {(uint8_t*)&att_decl_svc, 0x0010, (((PERM_RIGHT_ENABLE) << (PERM_POS_RD)) & (PERM_MASK_RD)),
                                            sizeof(sps_service), sizeof(sps_service), (uint8_t*)&sps_service},

    
    [SPSS_IDX_TX_DATA_CHAR]             = {(uint8_t*)&att_decl_char, 0x0002, (((PERM_RIGHT_ENABLE) << (PERM_POS_RD)) & (PERM_MASK_RD)),
                                           0,0,0},
    
    [SPSS_IDX_TX_DATA_VAL]              = {(uint8_t*)spss_tx_data_val.uuid, 0x0010, (((PERM_RIGHT_ENABLE) << (PERM_POS_NTF)) & (PERM_MASK_NTF)),
                                            (((PERM_RIGHT_ENABLE) << (PERM_POS_RI)) & (PERM_MASK_RI))|250, 0, 0},
    
    [SPSS_IDX_TX_DATA_CFG]              = {(uint8_t*)&att_decl_cfg, 0x0002, (((PERM_RIGHT_ENABLE) << (PERM_POS_RD)) & (PERM_MASK_RD)) | (((PERM_RIGHT_ENABLE) << (PERM_POS_WR)) & (PERM_MASK_WR))  | (((PERM_RIGHT_ENABLE) << (PERM_POS_WRITE_REQ)) & (PERM_MASK_WRITE_REQ)),
                                            sizeof(uint16_t), 0, 0},
    
    [SPSS_IDX_TX_DATA_DESC]             = {(uint8_t*)&att_decl_user_desc, 0x0002, (((PERM_RIGHT_ENABLE) << (PERM_POS_RD)) & (PERM_MASK_RD)),
                                            sizeof("Server TX Data") - 1, sizeof("Server TX Data") - 1, "Server TX Data"},
     
    [SPSS_IDX_RX_DATA_CHAR]             = {(uint8_t*)&att_decl_char, 0x0002, (((PERM_RIGHT_ENABLE) << (PERM_POS_RD)) & (PERM_MASK_RD)),
                                           0,0,0},
    
    [SPSS_IDX_RX_DATA_VAL]              = {(uint8_t*)spss_rx_data_val.uuid, 0x0010, (((PERM_RIGHT_ENABLE) << (PERM_POS_WR)) & (PERM_MASK_WR)) | (((PERM_RIGHT_ENABLE) << (PERM_POS_WRITE_COMMAND)) & (PERM_MASK_WRITE_COMMAND)),
                                            (((PERM_RIGHT_ENABLE) << (PERM_POS_RI)) & (PERM_MASK_RI))|250, 0, 0},
    
    [SPSS_IDX_RX_DATA_CFG]              = {(uint8_t*)&att_decl_cfg, 0x0002, (((PERM_RIGHT_ENABLE) << (PERM_POS_RD)) & (PERM_MASK_RD)) | (((PERM_RIGHT_ENABLE) << (PERM_POS_WR)) & (PERM_MASK_WR)) | (((PERM_RIGHT_ENABLE) << (PERM_POS_WRITE_REQ)) & (PERM_MASK_WRITE_REQ)),
                                            sizeof(uint16_t), 0, 0},
    
    [SPSS_IDX_RX_DATA_DESC]             = {(uint8_t*)&att_decl_user_desc, 0x0002, (((PERM_RIGHT_ENABLE) << (PERM_POS_RD)) & (PERM_MASK_RD)),
                                            sizeof("Server RX Data") - 1, sizeof("Server RX Data") - 1, "Server RX Data"},
    
    [SPSS_IDX_FLOW_CTRL_CHAR]           = {(uint8_t*)&att_decl_char, 0x0002, (((PERM_RIGHT_ENABLE) << (PERM_POS_RD)) & (PERM_MASK_RD)),
                                            0,0,0},         
    
    [SPSS_IDX_FLOW_CTRL_VAL]            = {(uint8_t*)spss_flow_ctrl_val.uuid, 0x0010, (((PERM_RIGHT_ENABLE) << (PERM_POS_RD)) & (PERM_MASK_RD)) | (((PERM_RIGHT_ENABLE) << (PERM_POS_WR)) & (PERM_MASK_WR)) | (((PERM_RIGHT_ENABLE) << (PERM_POS_NTF)) & (PERM_MASK_NTF))  | (((PERM_RIGHT_ENABLE) << (PERM_POS_WRITE_COMMAND)) & (PERM_MASK_WRITE_COMMAND)),
                                            1, 0, 0},
    
    [SPSS_IDX_FLOW_CTRL_CFG]            = {(uint8_t*)&att_decl_cfg, 0x0002, (((PERM_RIGHT_ENABLE) << (PERM_POS_RD)) & (PERM_MASK_RD)) | (((PERM_RIGHT_ENABLE) << (PERM_POS_WR)) & (PERM_MASK_WR))  | (((PERM_RIGHT_ENABLE) << (PERM_POS_WRITE_REQ)) & (PERM_MASK_WRITE_REQ)) | (((PERM_RIGHT_ENABLE) << (PERM_POS_WRITE_COMMAND)) & (PERM_MASK_WRITE_COMMAND)),
                                            sizeof(uint16_t), 0, 0},
    
    [SPSS_IDX_FLOW_CTRL_DESC]           = {(uint8_t*)&att_decl_user_desc, 0x0002, (((PERM_RIGHT_ENABLE) << (PERM_POS_RD)) & (PERM_MASK_RD)),
                                            sizeof("Flow Control") - 1, sizeof("Flow Control") - 1, "Flow Control"},
...
#line 38 "..\\..\\common\\src\\profiles\\spss\\sps_server_task.c"
#line 1 ".\\..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\api\\app_customs.h"
...
#line 31 ".\\..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\api\\app_customs.h"

#line 125 ".\\..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\api\\app_customs.h"
...
#line 39 "..\\..\\common\\src\\profiles\\spss\\sps_server_task.c"
#line 1 ".\\..\\..\\..\\..\\..\\sdk6\\sdk\\ble_stack\\profiles\\custom\\custom_common.h"
...
#line 19 ".\\..\\..\\..\\..\\..\\sdk6\\sdk\\ble_stack\\profiles\\custom\\custom_common.h"
...
int check_client_char_cfg(_Bool is_notification, const struct gattc_write_req_ind *param);
...
#line 70 ".\\..\\..\\..\\..\\..\\sdk6\\sdk\\ble_stack\\profiles\\custom\\custom_common.h"

#line 93 ".\\..\\..\\..\\..\\..\\sdk6\\sdk\\ble_stack\\profiles\\custom\\custom_common.h"

#line 40 "..\\..\\common\\src\\profiles\\spss\\sps_server_task.c"
...
#line 41 "..\\..\\common\\src\\profiles\\spss\\sps_server_task.c"
#line 42 "..\\..\\common\\src\\profiles\\spss\\sps_server_task.c"
                                    ...
                                    ke_task_id_t const src_id)
{
    ...
    else
    {
        ...
        sps_env->tx_flow_en = 1;
        sps_env->rx_flow_en = 1;
        
        
        sps_env->pending_ntf_cmp = 0;
        sps_env->pending_tx_ntf_cmp = 0;
        
        
        struct sps_server_enable_cfm * cfm = (struct sps_server_enable_cfm*) ke_msg_alloc(SPS_SERVER_ENABLE_CFM, src_id, dest_id, sizeof(struct sps_server_enable_cfm));
                                ...
                                ke_task_id_t const src_id)
{
    ...
    {
        { do { if (0) { if (!(sps_env->pending_ntf_cmp > 0)) { __breakpoint(0); } } } while (0); };
        sps_env->pending_ntf_cmp--;
        if (param->seq_num==0xF3C2)
        {
            sps_env->pending_tx_ntf_cmp = 0;



            struct sps_server_data_tx_cfm * cfm = (struct sps_server_data_tx_cfm*) ke_msg_alloc(SPS_SERVER_DATA_TX_CFM, prf_dst_task_get(&(sps_env->prf_env), (((src_id) >> 8) & 0xFF)), dest_id, sizeof(struct sps_server_data_tx_cfm));
...
{
    struct spss_env_tag *sps_env = ((struct spss_env_tag *)prf_env_get((TASK_ID_SPS_SERVER)));
    uint8_t conidx = (((dest_id) >> 8) & 0xFF);

    {
        _Bool success = sps_server_send_data( (void *)param, SPSS_IDX_TX_DATA_VAL, conidx, param->length );
        if ( success )
        {
 ...
 
{
    ...
    sps_env->rx_flow_en = (param->flow_control_state == FLOW_ON ? 1 : 0);
                                      ...
                                      ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    ...
    if (status == ATT_ERR_NO_ERROR)
    {
        if ( (att_idx==SPSS_IDX_TX_DATA_CFG) || (att_idx==SPSS_IDX_FLOW_CTRL_CFG) )
        {
            ...
            status = check_client_char_cfg((((perm) & (((PERM_RIGHT_ENABLE) << (PERM_POS_NTF))) & (PERM_MASK_NTF)) == (((PERM_RIGHT_ENABLE) << (PERM_POS_NTF)) & (PERM_MASK_NTF))), param);
        ...
        else if (att_idx==SPSS_IDX_FLOW_CTRL_VAL)
        {
            ...
            if(param->value[0] == FLOW_ON)
            {
                ...
                sps_env->pending_tx = 0;
            }
            else if (param->value[0] == FLOW_OFF)
            {
                sps_env->tx_flow_en = 0;
    ...
    cfm = (struct gattc_write_cfm*) ke_msg_alloc(GATTC_WRITE_CFM, src_id, dest_id, sizeof(struct gattc_write_cfm));
                                      ...
                                      ke_task_id_t const dest_id, ke_task_id_t const src_id)
{
    ...
    cfm = (struct gattc_read_cfm*)ke_msg_alloc(GATTC_READ_CFM, src_id, dest_id, (sizeof(struct gattc_read_cfm) + length));;
...
const struct ke_state_handler sps_server_default_handler = {sps_default_state, sizeof(sps_default_state)/sizeof(struct ke_msg_handler)};
