#line 1 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app.c"
...
#line 27 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app.c"
...
#line 30 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app.c"
#line 31 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app.c"
#line 32 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app.c"
#line 33 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app.c"
#line 34 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app.c"
...
#line 35 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app.c"
...
#line 36 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app.c"
...
#line 37 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app.c"
#line 38 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app.c"
#line 1 ".\\..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\api\\app_security.h"
...
#line 27 ".\\..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\api\\app_security.h"

#line 154 ".\\..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\api\\app_security.h"





#line 39 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app.c"
#line 40 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app.c"
...
#line 41 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app.c"
#line 42 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app.c"
#line 43 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app.c"
#line 44 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app.c"
#line 45 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app.c"
#line 46 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app.c"
#line 47 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app.c"

#line 49 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app.c"
...
struct app_env_tag app_env[(1)]  __attribute__((section("retention_mem_area0"), zero_init)); 

app_prf_srv_sec_t app_prf_srv_perm[(10)]        __attribute__((section("retention_mem_area0"), zero_init)); 

struct app_device_info device_info = {
                                       {(sizeof("SPS_531")-1), "SPS_531"},
                                        0x0000
                                     };
...
const struct prf_func_callbacks prf_funcs[] =
{
    ...
    {TASK_ID_SUOTAR,        app_suotar_create_db, 0},
    ...
    {TASK_ID_SPS_SERVER,    user_spss_create_db, user_spss_enable},
...
static const struct ke_task_desc TASK_DESC_APP = {0,
                                                  &app_default_handler,
                                                  app_state,
                                                  APP_STATE_MAX,
                                                  (1)};

static struct gapc_param_update_cmd *param_update_cmd[(1)] __attribute__((section("retention_mem_area0"), zero_init)); 
...
static timer_hnd adv_timer_id                                                      __attribute__((section("retention_mem_area0"), zero_init)); 

static void (*adv_timeout_callback)(void)                                          __attribute__((section("retention_mem_area0"), zero_init)); 
...
static _Bool app_task_in_user_app(enum KE_API_ID task_id)
{
    uint8_t i = 0;
...
{
    static uint8_t i __attribute__((section("retention_mem_area0"), zero_init)); 
    static uint8_t k __attribute__((section("retention_mem_area0"), zero_init)); 

    
    while(user_prf_funcs[k].task_id != TASK_ID_INVALID)
    {
        if (user_prf_funcs[k].db_create_func != 0)
        {
    ...
    {
        if ((prf_funcs[i].db_create_func != 0)
            && (!app_task_in_user_app(prf_funcs[i].task_id)))    
        {
...
#line 258 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app.c"
...
#line 289 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app.c"
...
void app_prf_enable(uint8_t conidx)
 {
     ...
     while(user_prf_funcs[i].task_id != TASK_ID_INVALID)
     {
        if(user_prf_funcs[i].enable_func != 0)
        {
    ...
    while(prf_funcs[i].task_id != TASK_ID_INVALID)
    {
        if(( prf_funcs[i].enable_func != 0 ) && (!app_task_in_user_app(prf_funcs[i].task_id)))
        {
...
#line 336 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app.c"
}

#line 366 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app.c"
...
static struct gapm_start_advertise_cmd* app_easy_gap_non_connectable_advertise_start_create_msg(void)
{
    ...
    if (adv_cmd == 0)
    {
        { do { if (0) { if (!((sizeof("\x11\x07\xb7\x5c\x49\xd2\x04\xa3\x40\x71\xa0\xb5\x35\x85\x3e\xb0\x83\x07" "\x03" "\x03" "\xF5\xFE")-1) <= 0x1F)) { __breakpoint(0); } } else { if (!((sizeof("\x11\x07\xb7\x5c\x49\xd2\x04\xa3\x40\x71\xa0\xb5\x35\x85\x3e\xb0\x83\x07" "\x03" "\x03" "\xF5\xFE")-1) <= 0x1F)) { wdg_reload(1); wdg_resume(); while(1); } } } while (0); }; 
        { do { if (0) { if (!((sizeof("")-1) <= 0x1F)) { __breakpoint(0); } } else { if (!((sizeof("")-1) <= 0x1F)) { wdg_reload(1); wdg_resume(); while(1); } } } while (0); };
        ...
        cmd->info.host.adv_data_len = (sizeof("\x11\x07\xb7\x5c\x49\xd2\x04\xa3\x40\x71\xa0\xb5\x35\x85\x3e\xb0\x83\x07" "\x03" "\x03" "\xF5\xFE")-1);
        memcpy(&(cmd->info.host.adv_data[0]), "\x11\x07\xb7\x5c\x49\xd2\x04\xa3\x40\x71\xa0\xb5\x35\x85\x3e\xb0\x83\x07" "\x03" "\x03" "\xF5\xFE", (sizeof("\x11\x07\xb7\x5c\x49\xd2\x04\xa3\x40\x71\xa0\xb5\x35\x85\x3e\xb0\x83\x07" "\x03" "\x03" "\xF5\xFE")-1));
        cmd->info.host.scan_rsp_data_len = (sizeof("")-1);
        memcpy(&(cmd->info.host.scan_rsp_data[0]), "", (sizeof("")-1));

        
        if ((sizeof("SPS_531")-1) > 0)
        {
            
            uint16_t total_adv_space = adv_cmd->info.host.adv_data_len + 2 + (sizeof("SPS_531")-1);
            
            uint16_t total_scan_space = adv_cmd->info.host.scan_rsp_data_len + 2 + (sizeof("SPS_531")-1);
...
static struct gapm_start_advertise_cmd* app_easy_gap_undirected_advertise_start_create_msg(void)
{
    ...
    if (adv_cmd == 0)
    {
        { do { if (0) { if (!((sizeof("\x11\x07\xb7\x5c\x49\xd2\x04\xa3\x40\x71\xa0\xb5\x35\x85\x3e\xb0\x83\x07" "\x03" "\x03" "\xF5\xFE")-1) <= (0x1F - 3))) { __breakpoint(0); } } else { if (!((sizeof("\x11\x07\xb7\x5c\x49\xd2\x04\xa3\x40\x71\xa0\xb5\x35\x85\x3e\xb0\x83\x07" "\x03" "\x03" "\xF5\xFE")-1) <= (0x1F - 3))) { wdg_reload(1); wdg_resume(); while(1); } } } while (0); }; 
        { do { if (0) { if (!((sizeof("")-1) <= 0x1F)) { __breakpoint(0); } } else { if (!((sizeof("")-1) <= 0x1F)) { wdg_reload(1); wdg_resume(); while(1); } } } while (0); };
        ...
        adv_cmd->info.host.adv_data_len = (sizeof("\x11\x07\xb7\x5c\x49\xd2\x04\xa3\x40\x71\xa0\xb5\x35\x85\x3e\xb0\x83\x07" "\x03" "\x03" "\xF5\xFE")-1);
        memcpy(&(cmd->info.host.adv_data[0]), "\x11\x07\xb7\x5c\x49\xd2\x04\xa3\x40\x71\xa0\xb5\x35\x85\x3e\xb0\x83\x07" "\x03" "\x03" "\xF5\xFE", (sizeof("\x11\x07\xb7\x5c\x49\xd2\x04\xa3\x40\x71\xa0\xb5\x35\x85\x3e\xb0\x83\x07" "\x03" "\x03" "\xF5\xFE")-1));
        adv_cmd->info.host.scan_rsp_data_len = (sizeof("")-1);
        memcpy(&(cmd->info.host.scan_rsp_data[0]), "", (sizeof("")-1));

#line 488 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app.c"

        
        if ((sizeof("SPS_531")-1) > 0)
        {
            
            uint16_t total_adv_space = 3 + adv_cmd->info.host.adv_data_len + 2 + (sizeof("SPS_531")-1);
...
static struct gapm_start_advertise_cmd* app_easy_gap_directed_advertise_start_create_msg(uint8_t ldc_enable)
{
    ...
    if (adv_cmd == 0)
    {
        ...
        cmd->op.addr_src = user_adv_conf.addr_src;
        cmd->channel_map = user_adv_conf.channel_map;
        memcpy(cmd->info.direct.addr.addr, user_adv_conf.peer_addr, 6*sizeof(uint8_t));
        cmd->info.direct.addr_type = user_adv_conf.peer_addr_type;
    }
    return adv_cmd;
}

#line 577 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app.c"
...
static struct gapc_param_update_cmd* app_easy_gap_param_update_msg_create(uint8_t conidx)
{
    ...
    if (param_update_cmd[conidx] == 0)
    {
        struct gapc_param_update_cmd* cmd;
        cmd = app_param_update_msg_create(conidx);
        { do { if (0) { if (!(conidx < (1))) { __breakpoint(0); } } } while (0); };
...
static struct gapm_start_connection_cmd* app_easy_gap_start_connection_to_msg_create(void)
{
    ...
    if (start_connection_cmd == 0)
    {
        ...
        else
        {
            ...
            memcpy(cmd->peers[0].addr.addr, user_central_conf.peer_addr_0, 6*sizeof(uint8_t));
...
static struct gapm_set_dev_config_cmd* app_easy_gap_dev_config_create_msg(void)
{
    ...
    if (set_dev_config_cmd == 0)
    {
        ...
        cmd->renew_dur = 0;
        memset(cmd->irk.key, 0, 0x10*sizeof(uint8_t));





#line 731 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app.c"
...
static void app_easy_gap_advertise_stop_handler(void)
{
    ...
    adv_timer_id=(0x0);
    if(adv_timeout_callback!=0)
    {
        timeout_callback = adv_timeout_callback;
        adv_timeout_callback = 0;
        timeout_callback();
    }
}

#line 783 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app.c"
...
#line 827 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app.c"
...
#line 897 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app.c"
...
void app_easy_gap_param_update_start(uint8_t conidx)
{
    ...
    app_param_update_msg_send(cmd);
    param_update_cmd[conidx] = 0;
}

#line 954 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app.c"
                                          ...
                                          const uint8_t *peer_addr, uint16_t intv)
{
    ...
    msg->nb_peers = 1;
    memcpy(&msg->peers[0].addr, peer_addr, 6);
...
void app_easy_gap_dev_configure(void)
{
    ...
    app_gapm_configure_msg_send(cmd);
    set_dev_config_cmd = 0;
}

void app_easy_gap_get_peer_features(uint8_t conidx)
{
    struct gapc_get_info_cmd *pkt = (struct gapc_get_info_cmd*) ke_msg_alloc(GAPC_GET_INFO_CMD, ( (ke_task_id_t)(((conidx) << 8)|(TASK_GAPC)) ), TASK_APP, sizeof(struct gapc_get_info_cmd));
...
#line 1069 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app.c"
