#line 1 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\i2c\\i2c.c"
...
#line 21 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\i2c\\i2c.c"
#line 22 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\i2c\\i2c.c"
#line 23 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\i2c\\i2c.c"
#line 24 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\i2c\\i2c.c"
#line 25 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\i2c\\i2c.c"
#line 26 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\i2c\\i2c.c"
#line 27 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\i2c\\i2c.c"
...
#line 57 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\i2c\\i2c.c"
...
static void tx_reply(_Bool success);


static void rx_reply(_Bool success);

#line 120 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\i2c\\i2c.c"
...
void i2c_init(const i2c_cfg_t *cfg)
{
    ...
    (* ( volatile uint16_t*)(&i2c->I2C_SS_SCL_HCNT_REGF)=(cfg->clock_cfg . ss_hcnt) );
    (* ( volatile uint16_t*)(&i2c->I2C_SS_SCL_LCNT_REGF)=(cfg->clock_cfg . ss_lcnt) );

    (* ( volatile uint16_t*)(&i2c->I2C_FS_SCL_HCNT_REGF)=(cfg->clock_cfg . fs_hcnt) );
    (* ( volatile uint16_t*)(&i2c->I2C_FS_SCL_LCNT_REGF)=(cfg->clock_cfg . fs_lcnt) );

    
    ( (* ( volatile uint16_t*)((&i2c->I2C_CON_REGF))=(((* ( volatile uint16_t*)(&i2c->I2C_CON_REGF) )&(~(uint16_t)((0x0006)))) | (((uint16_t)(cfg->speed))<<((((0x0006)))&0x0001? 0:(((0x0006)))&0x0002? 1:(((0x0006)))&0x0004? 2:(((0x0006)))&0x0008? 3: (((0x0006)))&0x0010? 4:(((0x0006)))&0x0020? 5:(((0x0006)))&0x0040? 6:(((0x0006)))&0x0080? 7: (((0x0006)))&0x0100? 8:(((0x0006)))&0x0200? 9:(((0x0006)))&0x0400?10:(((0x0006)))&0x0800?11: (((0x0006)))&0x1000?12:(((0x0006)))&0x2000?13:(((0x0006)))&0x4000?14: 15))) ));

    
    { do { if (0) { if (!(cfg->tx_fifo_level != 0)) { __breakpoint(0); } } } while (0); };
    { do { if (0) { if (!(cfg->rx_fifo_level != 0)) { __breakpoint(0); } } } while (0); };
    ( (* ( volatile uint16_t*)((&i2c->I2C_TX_TL_REGF))=(((* ( volatile uint16_t*)(&i2c->I2C_TX_TL_REGF) )&(~(uint16_t)((0x001F)))) | (((uint16_t)(cfg->tx_fifo_level - 1))<<((((0x001F)))&0x0001? 0:(((0x001F)))&0x0002? 1:(((0x001F)))&0x0004? 2:(((0x001F)))&0x0008? 3: (((0x001F)))&0x0010? 4:(((0x001F)))&0x0020? 5:(((0x001F)))&0x0040? 6:(((0x001F)))&0x0080? 7: (((0x001F)))&0x0100? 8:(((0x001F)))&0x0200? 9:(((0x001F)))&0x0400?10:(((0x001F)))&0x0800?11: (((0x001F)))&0x1000?12:(((0x001F)))&0x2000?13:(((0x001F)))&0x4000?14: 15))) ));
    ( (* ( volatile uint16_t*)((&i2c->I2C_RX_TL_REGF))=(((* ( volatile uint16_t*)(&i2c->I2C_RX_TL_REGF) )&(~(uint16_t)((0x001F)))) | (((uint16_t)(cfg->rx_fifo_level - 1))<<((((0x001F)))&0x0001? 0:(((0x001F)))&0x0002? 1:(((0x001F)))&0x0004? 2:(((0x001F)))&0x0008? 3: (((0x001F)))&0x0010? 4:(((0x001F)))&0x0020? 5:(((0x001F)))&0x0040? 6:(((0x001F)))&0x0080? 7: (((0x001F)))&0x0100? 8:(((0x001F)))&0x0200? 9:(((0x001F)))&0x0400?10:(((0x001F)))&0x0800?11: (((0x001F)))&0x1000?12:(((0x001F)))&0x2000?13:(((0x001F)))&0x4000?14: 15))) ));
    ...
    __NVIC_SetPriority(I2C_IRQn, 3);
    
    __NVIC_EnableIRQ(I2C_IRQn);
}
...
uint16_t i2c_master_transmit_buffer_sync(const uint8_t *data, uint16_t len, i2c_abort_t *abrt_code, uint32_t flags)
{
    ...
    while (len--)
    {
        ...
        i2c_write_byte(data[bytes_written] | ((len == 0 && (flags & I2C_F_ADD_STOP)) ? (0x0200) : 0));
...
uint16_t i2c_master_receive_buffer_sync(uint8_t *data, uint16_t len, i2c_abort_t *abrt_code, uint32_t flags)
{
    ...
    while (bytes_read < len)
    {
        while ((read_req < len) && (i2c_is_tx_fifo_not_full()))
        {
            ...
            i2c_write_byte((0x0100) | ((read_req == len && (flags & I2C_F_ADD_STOP)) ? (0x0200) : 0));
...
static void intr_master_transmit_buffer_handler(uint16_t mask)
{
    ...
    while ((txs->num < txs->len) && (i2c_is_tx_fifo_not_full()))
    {
        ...
        i2c_write_byte(txs->data[txs->num] | (((txs->num + 1 == txs->len) && (txs->flags & I2C_F_ADD_STOP)) ? (0x0200) : 0));
...
static void intr_master_receive_buffer_handler(uint16_t mask)
{
    ...
    while ((rxs->rr < rxs->len) && i2c_is_tx_fifo_not_full())
    {
        ...
        i2c_write_byte((0x0100) | ((rxs->rr == rxs->len && (rxs->flags & I2C_F_ADD_STOP)) ? (0x0200) : 0));
...
#line 989 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\i2c\\i2c.c"
...
void i2c_unregister_int(void)
{
    i2c_register_int(0, 0);

    
    __NVIC_ClearPendingIRQ(I2C_IRQn);
}
