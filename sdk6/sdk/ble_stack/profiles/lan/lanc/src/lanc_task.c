                                        ...
                                        ke_task_id_t const src_id)
{
    ...
    if (lanc_env != NULL)
    {
        ...
        do
        {
            ...
            ASSERT_ERROR(lanc_env->env[conidx] != NULL);
                                         ...
                                         ke_task_id_t const src_id)
{
    ...
    if (lanc_env != NULL)
    {
        ...
        do
        {
            ...
            ASSERT_ERROR(ke_state_get(dest_id) > LANC_FREE);
                                           ...
                                           ke_task_id_t const src_id)
{
    ...
    if (lanc_env != NULL)
    {
        ASSERT_ERROR(lanc_env->env[conidx]->operation != NULL);
        ASSERT_ERROR(((struct lanc_cmd *)lanc_env->env[conidx]->operation)->operation == LANC_LN_CTNL_PT_CFG_IND_OP_CODE);
