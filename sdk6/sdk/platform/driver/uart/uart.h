 ...
 *
 * @param[in] uart_id       Identifies which UART to use
 * @param[in] edssi_en      UART_BIT_CFG
 ****************************************************************************************
 */
...
__STATIC_FORCEINLINE uint16_t uart_fifo_error_getf(uart_t *uart_id)
{
    return (GetWord16(&uart_id->UART_LSR_REGF) & (UART_RFE))>>7;
}
...
#endif //(__EXCLUDE_UART2_HANDLER__)
