 ...
 ****************************************************************************************
 */
__STATIC_INLINE bool cts_is_current_time_valid(const struct cts_curr_time *time)
{
 ...
 ****************************************************************************************
 */
__STATIC_INLINE bool cts_is_local_time_info_valid(const struct cts_loc_time_info *info)
{
