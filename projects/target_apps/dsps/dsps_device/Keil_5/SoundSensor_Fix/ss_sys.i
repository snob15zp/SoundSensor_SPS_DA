...
#line 3 "..\\src\\SS_arch\\ss_sys.c"
#line 1 ".\\..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\systick\\systick.h"
...
#line 28 ".\\..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\systick\\systick.h"
#line 29 ".\\..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\systick\\systick.h"
...
#line 4 "..\\src\\SS_arch\\ss_sys.c"
#line 5 "..\\src\\SS_arch\\ss_sys.c"
...
#line 9 "..\\src\\SS_arch\\ss_sys.c"
#line 1 ".\\..\\src\\version.h"
#line 10 "..\\src\\SS_arch\\ss_sys.c"

#line 12 "..\\src\\SS_arch\\ss_sys.c"
#line 13 "..\\src\\SS_arch\\ss_sys.c"




_Bool SSS_calibration;

E_ADC_MODE_t	SS_ADC_MODE;
static uint16_t vars[32] = {0};
uint8_t verify_value_cb (uint8_t* param);

static const user_config_elem_t SSS_conf_table[] = 
{
	{0x1000, sizeof(MS_i32_AlertLevel_FastA), sizeof(MS_i32_AlertLevel_FastA), &MS_i32_AlertLevel_FastA, verify_value_cb, 0},
	{0x1001, sizeof(MS_i32_AlertLevel_C140dB_Peak), sizeof(MS_i32_AlertLevel_C140dB_Peak), &MS_i32_AlertLevel_C140dB_Peak, verify_value_cb, 0},
	{0x1002, sizeof(MS_i32_AlertLevel_Dose), sizeof(MS_i32_AlertLevel_Dose), &MS_i32_AlertLevel_Dose, verify_value_cb, 0},
	{0x1003, sizeof(MS_i32_AlertLevel_DoseM3dB), sizeof(MS_i32_AlertLevel_DoseM3dB), &MS_i32_AlertLevel_DoseM3dB, verify_value_cb, 0},
	{0x1004, sizeof(SSS_calibration), sizeof(SSS_calibration), &SSS_calibration, verify_value_cb, 0},
	{0x1005, sizeof(MS_i32_CalibrationFactor), sizeof(MS_i32_CalibrationFactor), &MS_i32_CalibrationFactor, verify_value_cb, 0},
};
static const user_config_elem_t SSS_RO_table[] = 
{
	{0x2000, sizeof(MS_i32_Level_FastA_dB), sizeof(MS_i32_Level_FastA_dB), &MS_i32_AlertLevel_FastA, verify_value_cb, 0},
	{0x2001, sizeof(MS_i32_Level_C_Peak_dB), sizeof(MS_i32_Level_C_Peak_dB), &MS_i32_Level_C_Peak_dB, verify_value_cb, 0},
	{0x2002, sizeof(MS_i32_Level_Dose_dB), sizeof(MS_i32_Level_Dose_dB), &MS_i32_Level_Dose_dB, verify_value_cb, 0},
};
...
void test_hnd_init(void)
{
    ...
    uint8_t version_len = strlen("0.1.2-B");
    char version[16] = {0};
    strncpy(version, "0.1.2-B", sizeof(version));
...
void SS_spi_switchoff_pins(uint32_t gpio_map)
{
    ...
    GPIO_ConfigurePin( spi_conf.cs.port, spi_conf.cs.pin, OUTPUT, PID_GPIO, 1 );
    GPIO_ConfigurePin( spi_conf.clk.port, spi_conf.clk.pin, INPUT_PULLDOWN, PID_GPIO, 0 );
    GPIO_ConfigurePin( spi_conf.mosi.port, spi_conf.mosi.pin, INPUT_PULLDOWN, PID_GPIO, 0 );
    GPIO_ConfigurePin( spi_conf.miso.port, spi_conf.miso.pin, INPUT_PULLDOWN, PID_GPIO, 0 );
