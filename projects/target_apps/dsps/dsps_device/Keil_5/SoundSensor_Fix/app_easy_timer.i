#line 1 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_easy\\app_easy_timer.c"
...
#line 28 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_easy\\app_easy_timer.c"

#line 31 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_easy\\app_easy_timer.c"
#line 32 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_easy\\app_easy_timer.c"
#line 33 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_easy\\app_easy_timer.c"
#line 34 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_easy\\app_easy_timer.c"
#line 35 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_easy\\app_easy_timer.c"
...
#line 36 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_easy\\app_easy_timer.c"
#line 37 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_easy\\app_easy_timer.c"
...
static timer_callback timer_callbacks[(APP_TIMER_API_LAST_MES - APP_TIMER_API_MES0 + 1)]          __attribute__((section("retention_mem_area0"), zero_init));


static timer_callback modified_timer_callbacks[(APP_TIMER_API_LAST_MES - APP_TIMER_API_MES0 + 1)] __attribute__((section("retention_mem_area0"), zero_init));
...
{
    for (int i = 0; i < (APP_TIMER_API_LAST_MES - APP_TIMER_API_MES0 + 1); i++)
    {
...
static void call_callback(const timer_hnd timer_id)
{
    ...
    if ((timer_id > 0) && (timer_id <= (APP_TIMER_API_LAST_MES - APP_TIMER_API_MES0 + 1)))
    {
        if (timer_callbacks[(timer_id - 1)] != 0)
        {
            timer_callback fn = timer_callbacks[(timer_id - 1)];
            
            if ((fn != timer_modified_handler) && (fn != timer_canceled_handler))
            {
                timer_callbacks[(timer_id - 1)] = 0;
                modified_timer_callbacks[(timer_id - 1)] = 0;
...
static void create_timer(timer_hnd timer_id, uint32_t delay)
{
    ...
    {
        ke_timer_set((timer_id - 1 + APP_TIMER_API_MES0), TASK_APP, delay);
    }
    else
    {
        arch_ble_force_wakeup(); 
        
        struct create_timer_struct *req = (struct create_timer_struct*) ke_msg_alloc(APP_CREATE_TIMER, TASK_APP, TASK_APP, sizeof(struct create_timer_struct));
                                ...
                                ke_task_id_t const src_id)
{
    ...
    { do { if (0) { if (!(param->delay > 0)) { __breakpoint(0); } } else { if (!(param->delay > 0)) { wdg_reload(1); wdg_resume(); while(1); } } } while (0); };                  
    { do { if (0) { if (!(param->delay < (4194300))) { __breakpoint(0); } } else { if (!(param->delay < (4194300))) { wdg_reload(1); wdg_resume(); while(1); } } } while (0); }; 

    ke_timer_set((param->timer_id - 1 + APP_TIMER_API_MES0), TASK_APP, param->delay);
...
static int cancel_timer_handler(ke_msg_id_t const msgid,
                                ...
                                ke_task_id_t const src_id)
{
    if ((param->timer_id > 0) && (param->timer_id <= (APP_TIMER_API_LAST_MES - APP_TIMER_API_MES0 + 1)))
    {
        int i = (param->timer_id - 1);
        if (timer_callbacks[i] == timer_canceled_handler)
        {
            timer_callbacks[i] = 0;
            modified_timer_callbacks[i] = 0;
        }
        else if (timer_callbacks[i] == timer_modified_handler)
        {
            struct modify_timer_struct *req = (struct modify_timer_struct*) ke_msg_alloc(APP_MODIFY_TIMER, TASK_APP, TASK_APP, sizeof(struct modify_timer_struct));
...
static int call_callback_handler(ke_msg_id_t const msgid,
                                 ...
                                 ke_task_id_t const src_id)
{
    call_callback((msgid - APP_TIMER_API_MES0 + 1));
    return KE_MSG_CONSUMED;
}
...
timer_hnd app_easy_timer(const uint32_t delay, timer_callback fn)
{
    ...
    { do { if (0) { if (!(delay > 0)) { __breakpoint(0); } } else { if (!(delay > 0)) { wdg_reload(1); wdg_resume(); while(1); } } } while (0); };                  
    { do { if (0) { if (!(delay < (4194300))) { __breakpoint(0); } } else { if (!(delay < (4194300))) { wdg_reload(1); wdg_resume(); while(1); } } } while (0); }; 
...
void app_easy_timer_cancel(const timer_hnd timer_id)
{
    ...
    {
        if ((timer_callbacks[(timer_id - 1)] != 0) &&
            (timer_callbacks[(timer_id - 1)] != timer_canceled_handler))
        {
            
            ke_timer_clear((timer_id - 1 + APP_TIMER_API_MES0), TASK_APP);
            ...
            struct cancel_timer_struct *req = (struct cancel_timer_struct*) ke_msg_alloc(APP_CANCEL_TIMER, TASK_APP, TASK_APP, sizeof(struct cancel_timer_struct));
...
timer_hnd app_easy_timer_modify(const timer_hnd timer_id, uint32_t delay)
{
    ...
    {
        if ((timer_callbacks[(timer_id - 1)] != 0) &&
            (timer_callbacks[(timer_id - 1)] != timer_modified_handler))
        {
            
            ke_timer_clear((timer_id - 1 + APP_TIMER_API_MES0), TASK_APP);

            
            modified_timer_callbacks[(timer_id - 1)] = timer_callbacks[(timer_id - 1)];
