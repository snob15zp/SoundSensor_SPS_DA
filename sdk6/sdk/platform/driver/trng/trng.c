...
#if defined (__DA14531__)
uint32_t trng_state_val              __SECTION_ZERO("trng_state"); // uninitialized variable placed always in RAM3 block
...
#if defined (__DA14531__)
void init_rand_seed_from_trng(void) __SECTION("system_init_run_once");
#endif
