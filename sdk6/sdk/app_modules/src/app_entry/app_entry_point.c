...
#if ((BLE_DWS_SERVER) && (!EXCLUDE_DLG_DWS))
    (process_event_func_t) user_dws_process_handler,
#endif

#if ((BLE_SPS_SERVER) && (!EXCLUDE_DLG_SPSS))
    (process_event_func_t) user_spss_process_handler,
#endif

#if ((BLE_SPS_CLIENT) && (!EXCLUDE_DLG_SPSS))
    (process_event_func_t) user_spsc_process_handler,
#endif


#if ((BLE_REMOTE_CONFIG) && (!EXCLUDE_DLG_REMOTE_CONFIG))
    (process_event_func_t) user_remote_config_process_handler,
#endif
