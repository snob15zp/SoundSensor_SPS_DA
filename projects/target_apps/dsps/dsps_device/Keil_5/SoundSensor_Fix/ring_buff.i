#line 1 "..\\src\\SPI_ADC\\ring_buff.c"
...
#line 3 "..\\src\\SPI_ADC\\ring_buff.c"
...
#line 4 "..\\src\\SPI_ADC\\ring_buff.c"
...
uint16_t RingBuffer_get_qntNode(void)
{
    ...
    return (((uint16_t)16) - ptr->idxOut) + ptr->idxIn;
}
