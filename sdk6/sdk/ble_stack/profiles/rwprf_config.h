...
#if defined(CFG_PRF_SPSS)
#define BLE_SPS_SERVER	1
#else
#define BLE_SPS_SERVER	0
#endif

#if defined(CFG_PRF_SPSC)
...
// REMOTE_CONFIG
#if defined(CFG_PRF_REMOTE_CONFIG)
#define BLE_REMOTE_CONFIG      1
#else
#define BLE_REMOTE_CONFIG      0
...
/// BLE_CLIENT_PRF indicates if at least one client profile is present
        ...
        || BLE_UDS_CLIENT || BLE_CTS_CLIENT|| BLE_GATT_CLIENT || BLE_SPS_CLIENT)
...
/// BLE_SERVER_PRF indicates if at least one server profile is present
        ...
        || BLE_UDS_SERVER || BLE_CTS_SERVER || BLE_SUOTA_RECEIVER || BLE_CUSTOM_SERVER || BLE_SPS_SERVER)
...
/// Profile Client
#define BLE_CLIENT_PRF              0
// Serial Port Server role
#define BLE_SPS_SERVER              0
// Serial Port Client role
#define BLE_SPS_CLIENT              0
// Wearable Service server role
#define BLE_DWS_SERVER              0
// Wearable Service client role
#define BLE_DWS_CLIENT              0
