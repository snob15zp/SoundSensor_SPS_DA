#line 1 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app_task.c"
...
#line 27 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app_task.c"



#line 31 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app_task.c"
#line 32 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app_task.c"
#line 33 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app_task.c"
#line 34 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app_task.c"
#line 35 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app_task.c"
#line 36 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app_task.c"
#line 37 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app_task.c"
#line 38 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app_task.c"
#line 39 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app_task.c"
...
#line 40 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app_task.c"
#line 41 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app_task.c"
...
#line 42 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app_task.c"
#line 1 ".\\..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\api\\app_security_task.h"
...
#line 23 ".\\..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\api\\app_security_task.h"

#line 51 ".\\..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\api\\app_security_task.h"

#line 43 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app_task.c"
...
#line 44 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app_task.c"
...
#line 45 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app_task.c"
#line 46 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app_task.c"
...
#line 47 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app_task.c"
#line 48 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app_task.c"
...
#line 49 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app_task.c"
#line 1 ".\\..\\src\\config\\user_modules_config.h"
...
#line 55 ".\\..\\src\\config\\user_modules_config.h"




#line 50 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app_task.c"
                                         ...
                                         ke_task_id_t const src_id)
{
    ...
    else
    {
        ...
        { do { if (0) { if (!(0)) { __breakpoint(0); } } else { if (!(0)) { wdg_reload(1); wdg_resume(); while(1); } } } while (0); };
    }
                                ...
                                ke_task_id_t const src_id)
{
    switch(param->operation)
    {
        ...
        case GAPM_SET_DEV_CONFIG:
        {
            ...
            {
                {if (user_app_callbacks . app_on_set_dev_config_complete != 0) user_app_callbacks . app_on_set_dev_config_complete();}
            }
        }
        break;
        ...
        {
            {if (user_app_callbacks . app_on_adv_nonconn_complete != 0) user_app_callbacks . app_on_adv_nonconn_complete(param->status);}
        }
        break;
        ...
        {
            {if (user_app_callbacks . app_on_adv_undirect_complete != 0) user_app_callbacks . app_on_adv_undirect_complete(param->status);}
        }
        break;
        ...
        {
            {if (user_app_callbacks . app_on_adv_direct_complete != 0) user_app_callbacks . app_on_adv_direct_complete(param->status);}
        }
        break;
        ...
        {
            {if (user_app_callbacks . app_on_scanning_completed != 0) user_app_callbacks . app_on_scanning_completed(param->status);}
        }
        break;
        ...
        case GAPM_CONNECTION_DIRECT:
            ...
            {
                {if (user_app_callbacks . app_on_connect_failed != 0) user_app_callbacks . app_on_connect_failed();}
            }
        break;
#line 203 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app_task.c"

        case GAPM_CANCEL:
        default:
            if (user_catch_rest_hndl != 0)
            {
                user_catch_rest_hndl(msgid, param, dest_id, src_id);
            }
        break;
    }
                                           ...
                                           ke_task_id_t const src_id)
{
    ...
    if (ke_state_get(dest_id) == APP_CONNECTABLE)
    {
        ...
        {if (user_app_callbacks . app_on_connection != 0) user_app_callbacks . app_on_connection(conidx, param);}
    }
    else
    {
        conidx = 0xFF;
                                ...
                                ke_task_id_t const src_id)
{
    switch(param->operation)
    {
        ...
        {
            if ((param->status != 0x00))
            {
                
                {if (user_app_callbacks . app_on_update_params_rejected != 0) user_app_callbacks . app_on_update_params_rejected(param->status);}
            }
            else
            {
                {if (user_app_callbacks . app_on_update_params_complete != 0) user_app_callbacks . app_on_update_params_complete();}
            }
        }
        break;
                                       ...
                                       ke_task_id_t const src_id)
{
    ...
    {
        app_env[conidx].conidx = 0xFF;
        app_env[conidx].connection_active = 0;
        {if (user_app_callbacks . app_on_disconnect != 0) user_app_callbacks . app_on_disconnect(param);}
    }
    else
    {
                                             ...
                                             ke_task_id_t const src_id)
{
    switch(param->req)
    {
        case GAPC_DEV_NAME:
        {
            { do { if (0) { if (!((sizeof("SPS_531")-1) <= 0xF8)) { __breakpoint(0); } } else { if (!((sizeof("SPS_531")-1) <= 0xF8)) { wdg_reload(1); wdg_resume(); while(1); } } } while (0); };

            struct app_device_name device_name;

            {if (user_app_callbacks . app_on_get_dev_name != 0) user_app_callbacks . app_on_get_dev_name(&device_name);}

            struct gapc_get_dev_info_cfm *cfm = (struct gapc_get_dev_info_cfm*)ke_msg_alloc(GAPC_GET_DEV_INFO_CFM, src_id, dest_id, (sizeof(struct gapc_get_dev_info_cfm) + device_name . length));;
        ...
        case GAPC_DEV_APPEARANCE:
        {
            ...
            {if (user_app_callbacks . app_on_get_dev_appearance != 0) user_app_callbacks . app_on_get_dev_appearance(&appearance);}

            struct gapc_get_dev_info_cfm *cfm = (struct gapc_get_dev_info_cfm*) ke_msg_alloc(GAPC_GET_DEV_INFO_CFM, src_id, dest_id, sizeof(struct gapc_get_dev_info_cfm));
        ...
        case GAPC_DEV_SLV_PREF_PARAMS:
        {
            ...
            {if (user_app_callbacks . app_on_get_dev_slv_pref_params != 0) user_app_callbacks . app_on_get_dev_slv_pref_params(&slv_params);}
...
#line 676 "..\\..\\..\\..\\..\\sdk6\\sdk\\app_modules\\src\\app_common\\app_task.c"
...
ke_state_t app_state[(1)] __attribute__((section("retention_mem_area0"), zero_init)); 
