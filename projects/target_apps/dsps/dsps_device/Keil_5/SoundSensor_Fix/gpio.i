#line 1 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\gpio\\gpio.c"
...
#line 21 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\gpio\\gpio.c"
#line 22 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\gpio\\gpio.c"
#line 23 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\gpio\\gpio.c"
#line 24 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\gpio\\gpio.c"
#line 25 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\gpio\\gpio.c"
...
#line 27 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\gpio\\gpio.c"
#line 29 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\gpio\\gpio.c"
...
#line 30 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\gpio\\gpio.c"

#line 46 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\gpio\\gpio.c"




GPIO_handler_function_t GPIOHandlerFunction[(GPIO4_IRQn - GPIO0_IRQn + 1)]     __attribute__((section("retention_mem_area0"), zero_init));
...
#line 72 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\gpio\\gpio.c"
...
void GPIO_init(void) __attribute__((section("system_init_run_once")));


void GPIO_init(void)
{
#line 143 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\gpio\\gpio.c"
}

void GPIO_SetPinFunction(GPIO_PORT port, GPIO_PIN pin, GPIO_PUPD mode, GPIO_FUNCTION function)
{
#line 153 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\gpio\\gpio.c"
    ...
    (* ( volatile uint16_t*)(mode_reg)=((uint16_t)mode | (uint16_t)function) );
}
...
GPIO_FUNCTION GPIO_GetPinFunction(GPIO_PORT port, GPIO_PIN pin)
{
    ...
    return (GPIO_FUNCTION) ( ((* ( volatile uint16_t*)(mode_reg) )&( (uint16_t)((0x001F)) )) >> (((0x001F))&0x0001? 0:((0x001F))&0x0002? 1:((0x001F))&0x0004? 2:((0x001F))&0x0008? 3: ((0x001F))&0x0010? 4:((0x001F))&0x0020? 5:((0x001F))&0x0040? 6:((0x001F))&0x0080? 7: ((0x001F))&0x0100? 8:((0x001F))&0x0200? 9:((0x001F))&0x0400?10:((0x001F))&0x0800?11: ((0x001F))&0x1000?12:((0x001F))&0x2000?13:((0x001F))&0x4000?14: 15) );
}

void GPIO_ConfigurePin(GPIO_PORT port, GPIO_PIN pin, GPIO_PUPD mode, GPIO_FUNCTION function,
                        const _Bool high)
{
#line 187 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\gpio\\gpio.c"
...
void GPIO_ConfigurePinPower(GPIO_PORT port, GPIO_PIN pin, GPIO_POWER_RAIL power_rail)
{
#line 204 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\gpio\\gpio.c"


    
    const int reg = (0x5000301E);

    
    const uint8_t bit_offset = pin;
#line 222 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\gpio\\gpio.c"

    uint32_t regval = 0;

    regval = (* ( volatile uint16_t*)(reg) );
    regval &= ~(1 << bit_offset);        
    regval |= power_rail << bit_offset;  
    (* ( volatile uint16_t*)(reg)=(regval) );
}

void GPIO_SetActive(GPIO_PORT port, GPIO_PIN pin)
{
#line 239 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\gpio\\gpio.c"
    ...
    (* ( volatile uint16_t*)(set_data_reg)=(1 << pin) );
}

void GPIO_SetInactive(GPIO_PORT port, GPIO_PIN pin)
{
#line 259 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\gpio\\gpio.c"
    ...
    (* ( volatile uint16_t*)(reset_data_reg)=(1 << pin) );
}

_Bool GPIO_GetPinStatus(GPIO_PORT port, GPIO_PIN pin)
{
#line 279 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\gpio\\gpio.c"
    ...
    return ( ((* ( volatile uint16_t*)(data_reg) ) & (1 << pin)) != 0 );
}
...
void GPIO_EnableIRQ(GPIO_PORT port, GPIO_PIN pin, IRQn_Type irq, _Bool low_input,
                     _Bool release_wait, uint8_t debounce_ms)
{
...
#line 351 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\gpio\\gpio.c"


    const uint8_t   KBRD_IRQn_SEL_BASE[] = {
        1,
    };
#line 364 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\gpio\\gpio.c"

    ( (* ( volatile uint16_t*)(((0x5000140C)))=(((* ( volatile uint16_t*)((0x5000140C)) )&(~(uint16_t)(((0x0040) << (irq-GPIO0_IRQn))))) | (((uint16_t)((debounce_ms > 0)))<<gpioshift16((((0x0040) << (irq-GPIO0_IRQn)))))) ));
    ( (* ( volatile uint16_t*)(((0x5000140C)))=(((* ( volatile uint16_t*)((0x5000140C)) )&(~(uint16_t)((0x003F)))) | (((uint16_t)(debounce_ms))<<gpioshift16(((0x003F))))) ));
    ( (* ( volatile uint16_t*)(((0x50001410)))=(((* ( volatile uint16_t*)((0x50001410)) )&(~(uint16_t)((0x0020) << (irq-GPIO0_IRQn)))) | (((uint16_t)(release_wait))<<gpioshift16(((0x0020) << (irq-GPIO0_IRQn))))) ));
    ( (* ( volatile uint16_t*)(((0x50001410)))=(((* ( volatile uint16_t*)((0x50001410)) )&(~(uint16_t)((0x0001) << (irq-GPIO0_IRQn)))) | (((uint16_t)(low_input))<<gpioshift16(((0x0001) << (irq-GPIO0_IRQn))))) ));
    ( (* ( volatile uint16_t*)(((0x50001400) + 2*(irq-GPIO0_IRQn)))=(((* ( volatile uint16_t*)((0x50001400) + 2*(irq-GPIO0_IRQn)) )&(~(uint16_t)(KBRD_IRQn_SEL))) | (((uint16_t)(KBRD_IRQn_SEL_BASE[port] + pin))<<gpioshift16((KBRD_IRQn_SEL)))) ));

    __NVIC_SetPriority(irq, 2);
    __NVIC_EnableIRQ(irq);
}

GPIO_IRQ_INPUT_LEVEL GPIO_GetIRQInputLevel(IRQn_Type irq)
{
    return (GPIO_IRQ_INPUT_LEVEL) ( ((* ( volatile uint16_t*)((0x50001410)) )&( (uint16_t)(((0x0001) << (irq-GPIO0_IRQn))) )) >> ((((0x0001) << (irq-GPIO0_IRQn)))&0x0001? 0:(((0x0001) << (irq-GPIO0_IRQn)))&0x0002? 1:(((0x0001) << (irq-GPIO0_IRQn)))&0x0004? 2:(((0x0001) << (irq-GPIO0_IRQn)))&0x0008? 3: (((0x0001) << (irq-GPIO0_IRQn)))&0x0010? 4:(((0x0001) << (irq-GPIO0_IRQn)))&0x0020? 5:(((0x0001) << (irq-GPIO0_IRQn)))&0x0040? 6:(((0x0001) << (irq-GPIO0_IRQn)))&0x0080? 7: (((0x0001) << (irq-GPIO0_IRQn)))&0x0100? 8:(((0x0001) << (irq-GPIO0_IRQn)))&0x0200? 9:(((0x0001) << (irq-GPIO0_IRQn)))&0x0400?10:(((0x0001) << (irq-GPIO0_IRQn)))&0x0800?11: (((0x0001) << (irq-GPIO0_IRQn)))&0x1000?12:(((0x0001) << (irq-GPIO0_IRQn)))&0x2000?13:(((0x0001) << (irq-GPIO0_IRQn)))&0x4000?14: 15) );
}

void GPIO_SetIRQInputLevel(IRQn_Type irq, GPIO_IRQ_INPUT_LEVEL level)
{
    ( (* ( volatile uint16_t*)(((0x50001410)))=(((* ( volatile uint16_t*)((0x50001410)) )&(~(uint16_t)(((0x0001) << (irq-GPIO0_IRQn))))) | (((uint16_t)(level))<<gpioshift16((((0x0001) << (irq-GPIO0_IRQn)))))) ));
}

void GPIO_ResetIRQ( IRQn_Type irq )
{
    ( (* ( volatile uint16_t*)(((0x5000140E)))=(((* ( volatile uint16_t*)((0x5000140E)) )&(~(uint16_t)((0x0001) << (irq-GPIO0_IRQn)))) | (((uint16_t)(1))<<gpioshift16(((0x0001) << (irq-GPIO0_IRQn))))) ));
}
...
#line 426 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\gpio\\gpio.c"

#line 438 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\gpio\\gpio.c"

#line 450 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\gpio\\gpio.c"

#line 462 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\gpio\\gpio.c"

#line 474 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\gpio\\gpio.c"



void GPIO_EnablePorPin(GPIO_PORT port, GPIO_PIN pin, GPIO_POR_PIN_POLARITY polarity, uint8_t por_time)
{
    { do { if (0) { if (!(( ((port == GPIO_PORT_0) && (pin <= GPIO_PIN_11) && (polarity <= GPIO_POR_PIN_POLARITY_HIGH)) ? ((polarity << 7) | (pin + 1)) : (0x00000000) ))) { __breakpoint(0); } } } while (0); }
    (* ( volatile uint16_t*)((0x50000042))=((0x007F) & por_time) );
    (* ( volatile uint16_t*)((0x50000040))=(( ((port == GPIO_PORT_0) && (pin <= GPIO_PIN_11) && (polarity <= GPIO_POR_PIN_POLARITY_HIGH)) ? ((polarity << 7) | (pin + 1)) : (0x00000000) )) );
}

void GPIO_DisablePorPin()
{
    (* ( volatile uint16_t*)((0x50000040))=(0) );
}
...
{
    return ((0x007F) & (* ( volatile uint16_t*)((0x50000042)) ));
}
