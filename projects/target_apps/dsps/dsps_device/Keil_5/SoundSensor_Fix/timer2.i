#line 1 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\timer\\timer2.c"
...
#line 16 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\timer\\timer2.c"
...
#line 17 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\timer\\timer2.c"
#line 18 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\timer\\timer2.c"
#line 19 "..\\..\\..\\..\\..\\sdk6\\sdk\\platform\\driver\\timer\\timer2.c"

void timer2_config(tim2_config_t *config)
{

    ( (* ( volatile uint16_t*)(((0x50003422)))=(((* ( volatile uint16_t*)((0x50003422)) )&(~(uint16_t)((0x0008)))) | (((uint16_t)(config->clk_source))<<((((0x0008)))&0x0001? 0:(((0x0008)))&0x0002? 1:(((0x0008)))&0x0004? 2:(((0x0008)))&0x0008? 3: (((0x0008)))&0x0010? 4:(((0x0008)))&0x0020? 5:(((0x0008)))&0x0040? 6:(((0x0008)))&0x0080? 7: (((0x0008)))&0x0100? 8:(((0x0008)))&0x0200? 9:(((0x0008)))&0x0400?10:(((0x0008)))&0x0800?11: (((0x0008)))&0x1000?12:(((0x0008)))&0x2000?13:(((0x0008)))&0x4000?14: 15))) ));

    ( (* ( volatile uint16_t*)(((0x50003422)))=(((* ( volatile uint16_t*)((0x50003422)) )&(~(uint16_t)((0x0004)))) | (((uint16_t)(config->hw_pause))<<((((0x0004)))&0x0001? 0:(((0x0004)))&0x0002? 1:(((0x0004)))&0x0004? 2:(((0x0004)))&0x0008? 3: (((0x0004)))&0x0010? 4:(((0x0004)))&0x0020? 5:(((0x0004)))&0x0040? 6:(((0x0004)))&0x0080? 7: (((0x0004)))&0x0100? 8:(((0x0004)))&0x0200? 9:(((0x0004)))&0x0400?10:(((0x0004)))&0x0800?11: (((0x0004)))&0x1000?12:(((0x0004)))&0x2000?13:(((0x0004)))&0x4000?14: 15))) ));
}

void timer2_pwm_freq_set(uint32_t pwm_freq, uint32_t input_freq)
{
    (* ( volatile uint16_t*)((0x50003408))=((input_freq / pwm_freq) - 1u) );
}

void timer2_pwm_signal_config(tim2_pwm_config_t *pwm_config)
{
    { do { if (0) { if (!(pwm_config->pwm_dc <= 100u)) { __breakpoint(0); } } } while (0); };

    uint32_t counter, dc;

    counter = (* ( volatile uint16_t*)((0x50003408)) ) + 1u;
    dc      = (counter * (pwm_config->pwm_dc)) / 100u;

    { do { if (0) { if (!(pwm_config->pwm_offset <= 100u)) { __breakpoint(0); } } } while (0); };
    ...
    switch (pwm_config->pwm_signal)
    {
        case TIM2_PWM_2:
        {
            ...
            (* ( volatile uint16_t*)((0x5000340A))=(offset) );
            (* ( volatile uint16_t*)((0x50003416))=(dc + offset) );
        ...
        case TIM2_PWM_3:
        {
            ...
            (* ( volatile uint16_t*)((0x5000340C))=(offset) );
            (* ( volatile uint16_t*)((0x50003418))=(dc + offset) );
        ...
        case TIM2_PWM_4:
        {
            ...
            (* ( volatile uint16_t*)((0x5000340E))=(offset) );
            (* ( volatile uint16_t*)((0x5000341A))=(dc + offset) );
        ...
        case TIM2_PWM_5:
        {
            (* ( volatile uint16_t*)((0x50003410))=(offset) );
            (* ( volatile uint16_t*)((0x5000341C))=(dc + offset) );
            break;
        }

        case TIM2_PWM_6:
        {
            (* ( volatile uint16_t*)((0x50003412))=(offset) );
            (* ( volatile uint16_t*)((0x5000341E))=(dc + offset) );
            break;
        }

        case TIM2_PWM_7:
        {
            (* ( volatile uint16_t*)((0x50003414))=(offset) );
            (* ( volatile uint16_t*)((0x50003420))=(dc + offset) );
            break;
        }
