#line 1 "..\\..\\..\\..\\..\\sdk6\\sdk\\ble_stack\\profiles\\prf.c"
...
#line 30 "..\\..\\..\\..\\..\\sdk6\\sdk\\ble_stack\\profiles\\prf.c"

#line 33 "..\\..\\..\\..\\..\\sdk6\\sdk\\ble_stack\\profiles\\prf.c"
...
#line 221 "..\\..\\..\\..\\..\\sdk6\\sdk\\ble_stack\\profiles\\prf.c"
...
#line 241 "..\\..\\..\\..\\..\\sdk6\\sdk\\ble_stack\\profiles\\prf.c"
...
#line 873 "..\\..\\..\\..\\..\\sdk6\\sdk\\ble_stack\\profiles\\prf.c"
...
#line 933 "..\\..\\..\\..\\..\\sdk6\\sdk\\ble_stack\\profiles\\prf.c"





#line 944 "..\\..\\..\\..\\..\\sdk6\\sdk\\ble_stack\\profiles\\prf.c"
    ...
    {TASK_ID_SPS_SERVER,    (prfif_func_t)spss_prf_itf_get},
...
struct prf_env_tag
{
    ...
    struct prf_task_env prf[((sizeof(prf_if) / sizeof(struct profile_interface)) - 1)];
};
...
const rom_prf_cfg_t rom_prf_cfg =
{
    prf_if,                     
    &prf_env,                   
    ((sizeof(prf_if) / sizeof(struct profile_interface)) - 1),       
};

#line 1118 "..\\..\\..\\..\\..\\sdk6\\sdk\\ble_stack\\profiles\\prf.c"

extern const struct prf_task_cbs *prf_itf_get(uint16_t task_id);

void prf_init_func(_Bool reset)
{
    uint8_t i = 0;
    ...
    if(!reset)
    {
        ...
        while (((sizeof(prf_if) / sizeof(struct profile_interface)) - 1) && (i < ((sizeof(prf_if) / sizeof(struct profile_interface)) - 1)))
        {
            prf->env  = 0;
            ...
            prf->desc.default_handler = 0;
            prf->desc.state           = 0;
            prf->desc.idx_max         = 0;

            prf->desc.state_max       = 0;
            prf->desc.state_handler   = 0;
    ...
    else
    {
        ...
        while (((sizeof(prf_if) / sizeof(struct profile_interface)) - 1) && (i < ((sizeof(prf_if) / sizeof(struct profile_interface)) - 1)))
        {
            ...
            ke_task_msg_flush(((prf->task) & 0xFF));
...
void prf_create_func(uint8_t conidx)
{
    ...
    while (((sizeof(prf_if) / sizeof(struct profile_interface)) - 1) && (i < ((sizeof(prf_if) / sizeof(struct profile_interface)) - 1)))
    {
#line 1197 "..\\..\\..\\..\\..\\sdk6\\sdk\\ble_stack\\profiles\\prf.c"
